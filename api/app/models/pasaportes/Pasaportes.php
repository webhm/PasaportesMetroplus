    ...
    public function nuevoPasaporte()
    {
        try {
            ...
            foreach ($encuesta as $key => $value) {
                ...
                if ($value[0] == 'rq5_1') {
                    $_respuestas['rq5'] = $_respuestas['rq5'] . ', Hora: ' . $value[1];
                }
            ...
            $_respuestas['NHC'] = $nhc;
            $_respuestas['PTE'] = $pte['PTE'];
            $_respuestas['groupName'] = $user_data['groupName'];

            $data = array(
                'pte' => $pte,
                'preferencias' => $_respuestas,
            );
            ...
            $this->generarPasaporte($_respuestas);
